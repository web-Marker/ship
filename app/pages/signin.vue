          ...
          <div class="w-full px-4">
            ...
            >
              ...
              <div class="mt-6">
                <button
                  type="button"
                  class="flex w-full items-center justify-center gap-3 rounded-sm border border-gray-300 bg-white px-9 py-4 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50"
